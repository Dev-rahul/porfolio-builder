          ...
          fields: [
            {
              ...
              options: [
                ...
                { label: 'Bento Box — Modern grid layout', value: 'bento' },
                { label: 'Glassmorphism — Frosted mesh gradients', value: 'glass' },
                { label: 'Brutalist — High contrast & bold', value: 'brutalist' },
                { label: 'Timeline — Journey focused', value: 'timeline' },
                { label: 'Cyberpunk — Neon & techy', value: 'cyberpunk' },
                { label: 'Creative — Playful & asymmetrical', value: 'creative' },
                { label: 'Zen — Minimalist earthy tones', value: 'zen' },
              ],
              default: 'minimal',
            },
          ],
...
export default function AdminPage() {
  useEffect(() => {
    ...
    // Load Decap CMS script (Identity widget is already loaded globally via layout)
